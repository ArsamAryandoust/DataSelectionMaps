...
def plot_data_selection_maps(HYPER_ADDVIS):
    ...
    def customize_plot(iteration):
        ...
        # set subplot titles
        ax.set_title(
            HYPER_ADDVIS.SUB_TITLE_LIST[plot_counter-1].format(iteration+1) 
        )
            ...
            for exp_type in exp_type_list:
                ...
                if 'values' in result_type_list:
                    ...
                    if 'spacetime_selection.csv' in file_type_list:
                        ...
                        path_to_saving_dataselectionmaps = path_to_figures + 'data selection maps/'
                        if not os.path.exists(path_to_saving_dataselectionmaps):
                            os.mkdir(path_to_saving_dataselectionmaps)
                        ...
                        for AL_variable in query_variables_act_lrn:
                            for AL_variant in query_variants_act_lrn:
                                ...
                                # create figure
                                fig = plt.figure(figsize=(16, HYPER_ADDVIS.N_ROWS_MAPS * 8))
                                ...
                                plot_counter= 1
                                ax = fig.add_subplot(HYPER_ADDVIS.N_ROWS_MAPS, HYPER_ADDVIS.N_COLS_MAPS, plot_counter, projection='3d')
                                ...
                                n_iter_plot = HYPER_ADDVIS.N_ROWS_MAPS * HYPER_ADDVIS.N_COLS_MAPS - 1
                                ...
                                # create saving paths 
                                saving_path = (
                                    path_to_saving_dataselectionmaps 
                                    + AL_variable
                                    + ' '
                                    + AL_variant
                                    + '.pdf'
                                ...
                                fig.legend(handles=legend_elements, loc='upper right', bbox_to_anchor=(0.6, 1))
